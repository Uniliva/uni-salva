...
1 - Architecting for the cloud: Best practices 2 - AWS well-architected framework
...
![Escalabilidade](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819052819070.png>)
...
![Alta disponibilidade](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819053332013.png>)

***

### Serverless

![serveless](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903201544942.png>)
...
*   **Termos importante**
    ...
    * RTO - Recover point objective - está relacionado a tempo de recuperação de desastre.
    ...
    ![rpo-rto](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909060015823.png>)

#### Estratégias de DR

![dr-estrategias](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909061054824.png>)

*   **Backup e Restore**

    ​ ![bkp-restore](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909061455821.png>)
...
*   **Pilot Light**
    ...
    ​ ![dr-pilot](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909062035023.png>)
...
*   **Warm standby**
    ...
    ​ ![dr-warm-standby](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909062340297.png>)
...
*   **hot site / multi site approach**
    ...
    ![hot-site](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909062732217.png>)

    ![DR-muilt-site](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909062821953.png>)
...
![dicas](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909063130084.png>)
...
![athena-well-arch](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905115942523.png>)
...
![well-arch-search](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905130015143.png>)
...
![glue](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905124633707.png>)

* Pode ser usado com **Athena**, **Redshift**, **EMR** para se criar um catalogo de dados (dataSet) reutilizável (GLUE Data catalog).

![glue-catalog](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905124749244.png>)

***

### AWS Kinesis

![Amazon Kinesis](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/product-page-diagram\_Amazon-Kinesis\_Evolve-from-batch-to-real-time-Analytics.d7ed76be304a30be5720fd159469f157e7c09ede.png>)
...
*   O ordenação dos dados pode ser feita passando a mesma chave de partição, pois assim os dados serão enviado para o mesmo **shard**.
    ...
    ![chave-partição](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903061639616.png>)
* Tipo de aplicação
...
* Captura, processa e armazena fluxos de dados.![data-streams](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903054120413.png>)
...
![data-firehose](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903055128503.png>)
...
*   Analisa fluxos de dados com SQL e Apache Flink.
    ...
    ![data-analytics](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903055735875.png>)
...
!\[Como o Amazon Quicksight funciona]\(certificacao-aws.assets/How QuickSight Works\_without Q\_final.026e51297c1fa18b850ce2ffc1575a9124bbad16.png)
...
![cost-explorer](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911104942473.png>)
...
![Amazon SNS - SMS](../../02%20-%20Cloud%20notes/01%20-%20AWS/01-aws-cloud-architect/certificacao-aws.assets/Product-Page-Diagram\_Amazon-SNS\_2-SMS-How-it-works@1.5x.4c649e5fe667e525de01e8c88024d782d8a25ccf.png)
...
*   **SNS + SQS - Fan Out pattern**
    ...
    * A ideia é usar um tópico SNS na frente de **N** fila para garantir que aquela mensagem possa se processado por **N** sistema, seja para evitar perda de dados ou por causas de serviços que só permitem notificar um único tópico (ex: **S3 events**).
    ...
    ![fan out](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210902211203812.png>)

    * **Message Filtering** - permite filtrar as mensagem e notificar os assinantes de acordo com os filtros.

    ![message-filter](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210902211615363.png>)

***

### Amazon SQS

![SQS](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/5e3f44ce52788a4fb8b8432e4441bf3f-SQS-diagram.svg>)
...
* **Request-Response System**
  ...
  * ![request-response-system](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210902210040788.png>)

### SQS x SNS x Kinesis

* Apesar se serem serviços de mensageira, há diferencia sobre o funcionamento deles.

![SQS x SNS x Kinesis](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903062441530.png>)
...
* **Placement Groups** - Grupos de Posicionamento
  *   Permite decide a estratégia posicionamento das instâncias EC2. ou seja onde vai ficar as instâncias de vai ser:
      ...
      * **Partition** - Similar ao **Spread**, mas as instâncias ficam espalhadas em diferentes partições (conjunto de Racks) numa AZ. Pode escalar para centenas de instâncias por grupo, usadas com o Hadoop, Kafka, Cassandra.
      ...
      ![AWS - Placement Groups](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/placementgroups.jpg>)
...
![Tipos de instancias](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819053521220.png>)
...
![VPC (Virtual Private Cloud)](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819053609626.png>)

![VPC (Virtual Private Cloud)](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819053632802.png>)
...
![ENI - interface de rede elástica](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819053719805.png>)

![Movendo ENI](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819053745468.png>)
...
![Secure Group](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819053823185.png>)

* [Amazon VPC - Security Groups](https://docs.aws.amazon.com/vpc/latest/userguide/VPC\_SecurityGroups.html)
...
* Há 4 tipos de **ELB**:
  ...
  * **Application load balancer** ALB (v2 - new generation - 2016)
    ...
    * Usados bastante numa arquitetura de microserviços ![Application load balancer](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819053919782.png>)
  ...
  * **Network load balancer** NLB -(v2 - new generation - 2017)
    ...
    * Tem um IP estatico por AZ, é possível usar um Elastic IP. ![Network load balancer](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819053951068.png>)
...
![Cross-Zone load balance](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054020911.png>)

* Configurações de disponibilidade

![Configurações de disponibilidade](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054054427.png>)
...
![LB SSL Certificates](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054122152.png>)

![SNI](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054148720.png>)
...
![Auto Scaling group](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054218858.png>)
...
![Ciclo de vida de uma instancia](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054243240.png>)
...
![beanstalk](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210823060717977.png>)

![tiers](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210823060841556.png>)
...
*   As Task podem ser disparadas pelo **Event Brigde**, isso dispara a execução do ECS.
    ...
    ![ecs](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903065745303.png>)

    ![ecs-ec2](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903070040856.png>)

    ![ecs-fargate](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903070257948.png>)

#### EC2 x Fargate

![fagate\_ec2](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903074403137.png>)

![ec2-fargate](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903074442934.png>)
...
![eks](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903074736202.png>)
...
* Lambdas@Edge
  *   É possível executar Lambdas em ponto de presenças, para auxiliar itens relacionados ao CDN , Route 53 ....
      ...
      ![lambda@edge](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903204606738.png>)

***

### AWS Step Functions

![step-function](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911102112816.png>)
...
![AWS Flow Framework Basic Concepts: Application Structure - AWS Flow  Framework for Java](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/swf-application-model.png>)
...
![well-arch](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905112316072.png>)
...
* ![aurora](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819082549024.png>)
* ![aurora-cluster](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819082823818.png>)

**Auroral - well architected**

![aurora-well-arch](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905112856784.png>)

**Conceitos avançados aurora**

**Aurora Replica - auto scaling**

![aurora-auto scaling](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819084400925.png>)

**Custom endpoints**

![custom-endpoint](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819084618981.png>)
...
* ![multi-master](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819085334494.png>)
...
* Global database
  ...
  * ![global](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819085935598.png>)
...
*   Caso de uso:
    ...
    * Deteção de fraude, propaganda localizada, recomendação de produtos.
    ...
    ![aurora-ml](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819091225067.png>)
...
*   Imagine que se tenha uma aplicação em produção que armazena informação num banco, ai surgi outra aplicação que gera relatório, e que ler varia tabelas, nesse cenário se cria uma replica só de leitura para essa nova aplicação
    ...
    ![read-replicas](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819064416702.png>)
...
*   Custo de rede (replicação).
    ...
    * Caso seja em regiões diferentes há um custo adicional de transferência
    ...
    ![price](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819064819009.png>)
...
*   Caso já tenha um banco que seja **Single AZ** e queira converte-lo para **multi AZ**, será criado por debaixo dos panos um snapshot do banco, que será restaurado no novo banco em outra AZ, e então iniciara o processo de sincronização entre os bancos.
    ...
    ![new db multi az](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819065600206.png>)
...
*   Para os bancos postgres, aurora e mysql, ha a opção de **IAM Autetication** que gera um token para se acessar o banco.
    ...
    * Todo o trafico seria feito usando SSL.
    ...
    ![iam-autatication-rds](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819081821387.png>)
...
![elastic-cache-well-arch](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905113428849.png>)
...
![redis](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210820053524603.png>)
...
![mancached](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210820053825076.png>)

#### Comparação

![comparação](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210820054422264.png>)
...
*   Autenticação:
    ...
    *   **Redis**
        ...
        * Permite usar **SSL** para os dados em transito.
        ...
        ![redis-access](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210820055640021.png>)
    * **MemCached**
      * Suporta autenticação baseada em SASL.
      * Lazy load feature

    ![lazy-load](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210820055934511.png>)
...
![dynamoDB-weel-arch](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905114039856.png>)
...
![data-importe](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905122049485.png>)
...
![sprectrum](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905122151802.png>)
...
*   Os Snapshots são feitos automaticamente de a cada **8 horas** ou a cada **5GB** ou podem ser agendados.
    ...
    ![redshit](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905121920707.png>)

#### Well architected

![well-arch-redshift](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905122323552.png>)
...
*   Visão **well architected.**
    ...
    ![netune-well-arch](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905125237432.png>)
...
![aws-dms](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909064002076.png>)
...
![sources-targets](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909064233727.png>)

***

### AWS SMS

![AWS SMS](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/AWS-Server-Migration-Service.png>)
...
![dataSync](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909071549775.png>)
...
*   Há 3 tipos:
    ...
    * **SnowMobile** - Caminhão, usado para transporta dados acima de 10 PBs para AWS.
    ...
    ![snow-family](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210902060123753.png>)
...
![bkp-service](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210909072322356.png>)
...
![cloud-formation](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911100149772.png>)
...
![cloud-trail](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210906211912761.png>)
...
* Tipo de eventos analisados:
  ...
  * **Cloud trail insights**
    ...
    * ![insights](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210906212303526.png>)
...
![unified-agente](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210906093405257.png>)
...
![cloud-metrics](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210906081300936.png>)
...
![config](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210906213344276.png>)
...
![notify](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210906213444390.png>)

***

### AWS Organizations

![AWS Organizations](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907065032639.png>)
...
![RAM](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907133859114.png>)
...
![ssm](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907151452111.png>)
...
![ssm-parameters](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907145157513.png>)
...
*   São declarados em forma de caminhos (**Paths**).
    ...
    ![ssm-paths](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907145248801.png>)
...
![tiers](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907145612224.png>)
...
![ttl-ssm](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907150009873.png>)
...
![api-gateway](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210903212259138.png>)
...
* **IAM Permissions**
  *   O API Gateway usa uma política para verificar quem tem acesso as APIs para "usuarios" da sua organização AWS, as credencias são enviadas no Header com **Sig 4**.
      ...
      ![iam-police](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210904052941839.png>)
* **Lamdba Authorizer**
  ...
  *   Pode se usar OAuth / SAML ... para autorizar.
      ...
      ![custom-autorization](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210904053330911.png>)
*   **Cognito user pools**
    ...
    * Permite usar autenticação externas (de terceiros , Google, Facebook).
    ...
    ![cognito](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210904053801646.png>)

    ![cognito](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210904053624684.png>)
...
*   É possível usar múltiplas origens no CDN, baseando em padrão da URL.
    ...
    ![multi-origin](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210901201915548.png>)
* uso:
  * **S3**
...
![origin-group](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210901202346642.png>)

#### Field level Encryption

![field-level](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210901202552403.png>)
...
![global-accelerator](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210901202859377.png>)
...
![route-53](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210820062829949.png>)
...
![vpc](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907200230003.png>)
...
*   Resolução de DNS, há duas configurações possíveis
    ...
    * **enableDnsHostname**
    ...
    ![dns](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907212451775.png>)

#### CIDR

![cidr](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/1By1Z1u0xilCm5OAtOqm3pg.png>)
...
* Usado para repartir os endereços IPs e definir ranges de ips.
  ...
  *   0.0.0.0/0 -> todos os IPs
      ...
      ![mask](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907165104378.png>)
...
![image-20210907203053110](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907203053110.png>)
...
![AWS VPC - Internet Gateway, Route Tables, NACLs | 4sysops](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/Public-and-private-route-table-diagram.png>)
...
![AWS — Difference between Internet Gateway and NAT Gateway | by Ashish Patel  | Awesome Cloud | Medium](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/1gftv4LSqU\_12kRqNwYISJw.png>)
...
![sg](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907213210726.png>)
...
![Learn AWS Network ACL and Security Groups in under 5 minutes | by João  Marcelo Souza | Medium](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/1K-Se2-uV-Y91vkGW3K0-8w.png>)
...
*   Não são transitivas, ou seja no exemplo abaixo a VPC A não esta conectada a VPC C.
    ...
    ![vpc-peering](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908191617520.png>)
*   Caso precise que elas se "vejam" e necessário criar um **VPC Peering** com as duas.

    ![vpc-peering](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908191928744.png>)
...
![Bastion Hosts](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908200020997.png>)
...
![Virtual Private Gateway](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908200507774.png>)
...
![dx](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908201934794.png>)
...
![DX-GW](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908202014628.png>)

* Alta disponibilidade

![DX](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908202426476.png>)
...
![AWS PrivateLink - VPC Endpoint Services](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908203529744.png>)
...
![AWS — Transit Gateway](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/1ghrEMYcgoEfzawAHq54v\_A.png>)
...
![net-cost](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908205716392.png>)

![image-20210908210015556](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908210015556.png>)

![image-20210908210158231](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908210158231.png>)

![image-20210908210357597](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210908210357597.png>)
...
![modelo-resp-compartilhada](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907161801611.png>)
...
* **IAM Conditions**
  *   Permite adicionar condições nas políticas de acessos AWS.
      ...
      ![conditions](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907124841446.png>)
* **IAM Permission Boundaries** (limite de permissões)
  ...
  *   SCP (Service control policies ).
      ...
      ![limite](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907130021397.png>)
* **Lógica da avaliação de política**

![Lógica da avaliação de política - AWS Identity and Access Management](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/PolicyEvaluationHorizontal.png>)
...
![Basic recomendations](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054310896.png>)
...
![AWS Directory Service](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907064249181.png>)
...
* Há varias maneiras de criar um IdP.
  ...
  *   **SAML 2.0**
      ...
      * Forma antiga de conectar, hoje usa-se o **Sigle Sign On**
      ...
      ![saml-2.0](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907062744488.png>)
  * **Custom Identity Broken.**
    ...
    *   **Identity Broken** chama o STS para gerar o Token de acesso.
        ...
        ![Identity Broken](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907063130204.png>)
  *   **Web Identity Federation com Cognito**

      * Permite dar acesso a um recurso usando provider como Facebook.

      ![Web Identity Federation com Cognito](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907063638182.png>)
...
*   É usado quando se tem uma Organização com muitas contas, ai ser configura para que quando o usuário faça o login apareça as contas que ele pode logar na AWS, sem ser necessário criar um usuário em cada conta toda vez. O acesso fica centralizado.
    ...
    ![sso](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907134228636.png>)
...
* Tipos de APIs:
  *   **AssumeRole**
      ...
      * Permite da acesso a ação a **sua própria conta** ou **outras contas** a realizar ações em sua conta.
      ...
      ![AssumeRole](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907061553994.png>)

      * Diagrama de acesso a outras contas

      ![cross-account](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907061716700.png>)
...
*   **Chaves do HSM**
    ...
    * Replicado em mais de uma AZ
    ...
    ![cloudhsm](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907151911356.png>)

    ![hms-kms](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907152024180.png>)

***

### AWS Shield

![aws-shield](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907152708797.png>)
...
![guard-duty](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907160116228.png>)
...
![inspect](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907160835588.png>)
...
![macie](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907161308569.png>)
...
![security-hub](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210907161531824.png>)
...
![storage](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210902070844946.png>)
...
![Tipos ebs](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054333580.png>) ![tipos-ebs](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054408303.png>)
...
![ebs-snapshot](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054545291.png>)
...
![efs](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054618860.png>)

**Uso**

![efs-uso](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054634544.png>)
...
![types](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054715506.png>)
...
![Encryption](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054838607.png>)
...
![Data consistency](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054900853.png>)
...
![Cross region replication](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819054942170.png>)
...
![Versioning](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819055012729.png>)
...
![lifecycle management](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819055054870.png>)
...
![Transfer acceleration](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819055118471.png>)
...
![Presigned urls](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210819055145289.png>)
...
![select-s3](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210901073640794.png>)

#### S3 Well Architected

![s3-well-arch](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905114534983.png>)
...
*   Tipos de armazenamento que é possivel configurar:
    ...
    *   **Files (S3 / FSx)** - Usado para armazenar arquivos.
        ...
        ![file-gw](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210902062908850.png>)
    * **Volumes (EBS)** - Usados para armazenar dados de backups, ou volumes.

    ![volume-gatway](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210902063040487.png>)

    * **Fitas (S3 Glacier) -** Usado onde há processos semelhantes fitas.

    ![type-gw](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210902063153289.png>)
...
!\[AWS Well Architected Framework Review]\(certificacao-aws.assets/Screen Shot 2019-09-09 at 16.40.22.pngwidth=2560\&name=Screen Shot 2019-09-09 at 16.40.22.png)
...
>
>     ![Operational excelence](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911113736922.png>)
...
>
> <img src="../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911113818679.png" alt="Security" data-size="original">
...
>
> <img src="../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911113941996.png" alt="Realibility" data-size="original">
...
>
> <img src="../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911113903778.png" alt="Perfome efficiente" data-size="original">
...
>
> <img src="../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911114006745.png" alt="Cost optimization" data-size="original">
...
*   Usuário pode criar lista de tarefas e armazenar dados no S3, tem que ter autenticação.
    ...
    *   **Solução visão nivel api**
    ...
    ![api-level](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905053728953.png>)

    *   **Solução visão acesso ao S3**

        > O Cognito via STS gera um token temporario para acessar o S3

    ![access-s3](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905053914308.png>)
    ...
    * **Cache para muitas leituras na DynamoDB**
    ...
    ![cache-dax](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905054333825.png>)
*   **Cache de responses**

    > Também seria possivel habilitar o caching no gateway, para cachear os requestes.

    ![gw-api-gw](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905054833125.png>)
...
*   **Solução arquivos staticos (site)**
    ...
    ![blog](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905055651238.png>)
...
![api-acess](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905060328372.png>)
...
*   **Solução para e-mail de boas vindas**
    ...
    ![user-welcome](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905060816093.png>)
...
![image-processing](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905061501865.png>)
...
![ms-ecs](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905062549322.png>)
...
![image-20210905062947575](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905062947575.png>)
...
![acess-valitation](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905064210992.png>)
...
![premio-users](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905074803997.png>)
...
![pipe-big-data](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210905102731999.png>)
...
![lambda-sns-sqs](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911053226958.png>)
...
![fan-out](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911053815606.png>)
...
![s3-events](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911054137997.png>)
...
![cache-strategies](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911054921713.png>)
...
*   Também é possível configurar um firewall num **EC2** para fazer esse bloqueio.
    ...
    ![ip-bloqueio](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911060135778.png>)
    ...
    * Caso na sua estrutura esteja usando um \*\*application load balance \*\*(ALB), e possível bloquear usando a **NACL** e configurar o **Security Group** das instâncias EC2 para aceitar o trafico apenas do **application Load balance**.
    ...
    ![alb-blocling-ip](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911060717080.png>)

    * Ou pode se instalar o **WAF** no **ALB**, onde se poderia criar regras de filtros de acesso.

    ![waf](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911061131017.png>)
    ...
    * Caso esteja usando um Network load balance, a unica forma de bloquear um ip seria usando o **NACL**. Pois o NLB não possui Security Group.
    ...
    ![nlb-blocking-ip](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911060927094.png>)
*   Caso esteja usando **CDN**, e possível usar o **WAF** na para bloquear o acesso. Antes mesmo dele chegar na **VPC**, não sendo necessário usar as **NACL**
    ...
    ![cdn-bloquin](<../../02 - Cloud notes/01 - AWS/01-aws-cloud-architect/certificacao-aws.assets/image-20210911061200043.png>)
...
* [Architecting for the cloud](https://d1.awsstatic.com/whitepapers/AWS\_Cloud\_Best\_Practices.pdf)
...
* [well-architected framework](https://d1.awsstatic.com/whitepapers/architecture/AWS\_Well-Architected\_Framework.pdf)
