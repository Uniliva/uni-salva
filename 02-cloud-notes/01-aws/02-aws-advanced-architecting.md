...
![image-20211013092939990](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013092939990.png>)

![image-20211015150336791](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015150336791.png>)

![image-20211015152708444](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015152708444.png>)

AWS SCT

![image-20211015154613534](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015154613534.png>)
...
![image-20211013134035269](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013134035269.png>)

* Uma que da o acesso e outra (trust police) que diz quem pode acessar essa role.
*   **Multiplas contas**

    ![image-20211013141254429](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013141254429.png>)
...
![image-20211013160715474](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013160715474.png>)

![image-20211013161337118](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013161337118.png>)

![image-20211013161836561](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013161836561.png>)

#### VMware on AWS solutions

![image-20211013162556867](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013162556867.png>)

![image-20211013162655092](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013162655092.png>)
...
![image-20211013162839262](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013162839262.png>)

![image-20211013163155083](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013163155083.png>)

#### Outposts

![image-20211013163536690](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013163536690.png>)
...
*   Serviços:
    ...
    ![image-20211013163606326](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013163606326.png>)
*   Opções de configuração

    ![image-20211013164010210](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013164010210.png>)
*   Comunicação

    ![image-20211013164351770](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013164351770.png>)
...
![image-20211013165428897](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211013165428897.png>)
...
*   #### Transit Gateway
    ...
    ![image-20211014093559752](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211014093559752.png>)
    ...
    *   Ver depois transit VPC?
        ...
        ![image-20211014094225159](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211014094225159.png>)
...
* PrivateLink
  *   ver VPC endpoints (interface endpoint - aponta para uma ENI (placa de rede), gateway endpoint - usar um recurso, tipo um S3).
      ...
      * Tem scope regional
      ...
      ![image-20211014101413382](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211014101413382.png>)
...
![image-20211014132847619](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211014132847619.png>)
...
* EKS Distro
  ...
  * ![image-20211014141951570](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211014141951570.png>)

#### ECS

![image-20211014133223155](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211014133223155.png>)

![image-20211014140314930](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211014140314930.png>)
...
![image-20211014155834148](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211014155834148.png>)
...
![image-20211015090806265](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015090806265.png>)

![image-20211015090937827](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015090937827.png>)
...
![image-20211015091102658](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015091102658.png>)

![image-20211015091635181](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015091635181.png>)

![image-20211015091822504](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015091822504.png>)
...
*   Necessario ter estrutura do organization
    ...
    ![image-20211015094355456](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015094355456.png>)
...
* AWS KMS
  ...
  * Ver criptografia S3
    ...
    *
        ...
        ![image-20211015103426848](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015103426848.png>)
    * SSE-KMS - Usa chave do S3 gerenciado pelo usuário (chave criado pelo usuario)
    *

        ![image-20211015103859080](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015103859080.png>)
    *   SSE-C - Usa uma chava criado pelo usuario e subida pelo usuario na aws. (aquela chave gerada fora da aws)

        ![image-20211015103642614](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015103642614.png>)
*   AWS CLOUDHSM
    ...
    * Usa o KMS para armazenar chaves se usado com o CloudHSM, o que ajuda muito em algumas soluções.
    ...
    ![image-20211015102755436](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015102755436.png>)
* AWS Secrets manager
  ...
  *   Semelhante ao Parameter store.
      ...
      * O Secrets manager tem scopo multi account e tem custo.
      ...
      ![image-20211015104705706](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015104705706.png>)
...
![image-20211015112244613](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015112244613.png>)

#### Data lakes

![image-20211015115507396](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015115507396.png>)

#### AWS Lake FOrmation

![image-20211015120905323](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015120905323.png>)
...
![image-20211015144301428](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015144301428.png>)

![image-20211015145125798](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015145125798.png>)

***

### 12 - Optimizing CostsAccounts

![image-20211015160317310](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015160317310.png>)

![image-20211015161022544](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015161022544.png>)

![image-20211015164300737](<../../02 - Cloud notes/01 - AWS/02-aws-advanced-architecting/.imagens/image-20211015164300737.png>)
